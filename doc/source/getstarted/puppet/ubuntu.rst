...
OVS_PMD_CORE_MASK default value is '4', which means core 3 (hyperthread sibling is
added later during the deployment). This default value doesn't work for NIC's from 
