...
Pre-requisites
==============
- Ubuntu 14 server fresh installation
- A non root user
...
git, socat, linux-headers-3.16.0-45-generic, fdutils and libxtst6.

| sudo apt-get install linux-headers-3.16.0-45-generic fdutils git socat libxtst6
