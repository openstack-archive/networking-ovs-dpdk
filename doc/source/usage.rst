...
**OVS_INTERFACE_DRIVER**
    (vfio-pci|igb_uio|uio_pci_generic|mlnx_uio) NIC driver to use for physical network interface(s). Note: drivers names are the ones supported by DPDK, i.e.: not the kernel names.
