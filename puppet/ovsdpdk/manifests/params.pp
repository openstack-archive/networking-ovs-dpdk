...
class ovsdpdk::params {
  ...
  $ovs_dir                  = "${dest}/ovs"
  #$ovs_git_tag              = '88058f19ed9aadb1b22d26d93e46b3fd5eb1ad32' # orig
  $ovs_git_tag              = 'f3ea2ad27fd076735fdb78286980749bb12fe1ce' # MARYAM
  #$ovs_git_tag              = 'cd4764fdd8ce0aa0063525dad0e67f20b3bcf6e9' # 2.5 branch 
