...
class TestOVSDPDKNeutronAgent(object):
    ...
    def setUp(self):
        ...
        with mock.patch.object(self.mod_agent.OVSDPDKNeutronAgent,
                               'setup_integration_br'),\
                mock.patch.object(self.mod_agent.OVSDPDKNeutronAgent,
    ...
    def _test_ovs_status(self, *args):
        ...
        with mock.patch.object(async_process.AsyncProcess, "_spawn"),\
                ...
                mock.patch.object(
                    self.mod_agent.OVSDPDKNeutronAgent,
    ...
    def _test_ancillary_bridges(self, bridges, ancillary):
        ...
        with mock.patch.object(self.mod_agent.OVSDPDKNeutronAgent,
                ...
                mock.patch(
                    ...
                    return_value=[]):
            self.agent = self.mod_agent.OVSDPDKNeutronAgent(
                             self._bridge_classes(), **self.kwargs)
